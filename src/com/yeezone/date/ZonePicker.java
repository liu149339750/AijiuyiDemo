...
//add-s zhangyaming Bug00003583
import android.content.SharedPreferences;
//add-e zhangyaming Bug00003583
...
public class ZonePicker extends ListFragment {
    private static final String TAG = "[Settings][ZonePicker]";
    ...
    private static final String KEY_PINYINNAME = "pyname";  // value: String
    ...
    private static final String ALPHABETICAL_ORDER = "ALPHABETICAL";
    private static final String TIMEZONE_ORDER = "TIMEZONE";
    SharedPreferences timezonePreferences;
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context,
        ...
        final String sortKey = (sortedByName ? KEY_PINYINNAME : KEY_OFFSET);
    ...
    public void onActivityCreated(Bundle savedInstanseState) {
        ...
        // Sets the adapter
        //chg-s zhangyaming Bug00003583
        //setSorting(true);
        timezonePreferences = getActivity().getPreferences(Context.MODE_PRIVATE);
        String order = timezonePreferences.getString(ORDER_KEY, null);
        Log.d(TAG, "onActivityCreated() : order == " + order);
        setSorting(order == TIMEZONE_ORDER ? true : false);
        //chg-e zhangyaming Bug00003583
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //add-s zhangyaming Bug00003583
        SharedPreferences.Editor editor = timezonePreferences.edit();
        //add-e zhangyaming Bug00003583
        switch (item.getItemId()) {

            case MENU_TIMEZONE:
                //add-s zhangyaming Bug00003583
                editor.putString(ORDER_KEY, TIMEZONE_ORDER);
                editor.commit();
                //add-e zhangyaming Bug00003583
                setSorting(true);
                return true;
            ...
            case MENU_ALPHABETICAL:
                //add-s zhangyaming Bug00003583
                editor.putString(ORDER_KEY, ALPHABETICAL_ORDER);
                editor.commit();
                //add-e zhangyaming Bug00003583
                setSorting(false);
                return true;
        ...
        try {
            ...
            while (xrp.getEventType() != XmlResourceParser.END_TAG) {
                ...
                if (xrp.getName().equals(XMLTAG_TIMEZONE)) {
                    ...
                    String pingYinName = xrp.getAttributeValue(null, KEY_PINYINNAME);
                    String displayName = xrp.nextText();
                    addItem(myData, id, displayName, pingYinName, date);
                }
                while (xrp.getEventType() != XmlResourceParser.END_TAG) {
                    xrp.next();
                }
    ...
    private static void addItem(
            List<HashMap<String, Object>> myData, String id, String displayName, String pinYinName,
            long date) {
        final HashMap<String, Object> map = new HashMap<String, Object>();
        map.put(KEY_ID, id);
        map.put(KEY_DISPLAYNAME, displayName);
        map.put(KEY_PINYINNAME, pinYinName);
    ...
    private static class MyComparator implements Comparator<HashMap<?, ?>> {
        ...
        public int compare(HashMap<?, ?> map1, HashMap<?, ?> map2) {
            ...
            if (value1 == null || value2 == null) {
                value1 = map1.get(KEY_DISPLAYNAME);
                value2 = map2.get(KEY_DISPLAYNAME);
            }
            /*
